...
```{r}
clean_set <- read.csv("C:/Users/crazy/OneDrive/Desktop/Winter 2024/STA 141C/Project/cleanedData.csv")
```
...
for (variable in c("tPrec", "atmosPStatn", "rad", "dpTemp", "airHum", "windDir", "windSp", "lat", "long")) {
  ...
  # and the next degree is less than 0.5 it is not significant
